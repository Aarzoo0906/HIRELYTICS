  ...
  return (
    <div className="relative flex min-h-screen flex-col overflow-hidden bg-slate-950">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute top-16 right-10 h-64 w-64 rounded-full bg-cyan-500/10 blur-3xl"></div>
        <div className="absolute bottom-10 left-10 h-56 w-56 rounded-full bg-teal-500/10 blur-3xl"></div>
      </div>
        ...
        <div className="grid w-full gap-8 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="hidden rounded-[2rem] border border-white/8 bg-white/5 p-10 text-white shadow-2xl shadow-black/20 backdrop-blur-sm lg:block">
            <Link to="/" className="inline-flex items-center gap-2">
              <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-teal-400 to-emerald-500 font-black text-slate-900">
                H
              </div>
          ...
          <div className="mx-auto flex w-full max-w-md items-center">
            <div className="w-full rounded-[2rem] border border-white/10 bg-slate-900/90 p-8 shadow-2xl shadow-black/20 backdrop-blur-sm">
              <div className="mb-8">
                <p className="mb-3 text-sm font-semibold tracking-[0.3em] text-teal-300 uppercase">Create account</p>
              ...
              <p className="mt-6 text-center text-sm text-slate-400">
                ...
                <Link to="/login" className="font-semibold text-teal-300 transition-colors hover:text-teal-200">
                  Sign in
                </Link>
              </p>
            </div>
